...
public class CartServiceImplementation 
	...
	@Autowired private CartItemsRepository itemRepo;
	...
	public void updateCartItem(CartData data) {
		...
		CartItem item = itemRepo.findByCartIdAndProdId(cart.getId(), pid).orElseThrow(() -> new RuntimeException("CartItem not found"));
